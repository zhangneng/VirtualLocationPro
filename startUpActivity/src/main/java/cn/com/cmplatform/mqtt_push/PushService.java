...
import cn.com.cmplatform.login.LoginMainActivity;
...
public class PushService extends Service {
	...
	private static final String MQTT_HOST = "10.8.16.123";
	...
	private PushConnectionLog mLog;
	...
	private void showNotification(String text) {
		...
		n.icon = cn.com.cmplatform.gameplatform.R.drawable.icon;
		n.when = System.currentTimeMillis();

		// Simply open the parent activity
		PendingIntent pi = PendingIntent.getActivity(this, 0, new Intent(this,
				LoginMainActivity.class), 0); // 点击推送进入主界面
		// Change the name of the notification here
		n.setLatestEventInfo(this, NOTIF_TITLE, unicodeToChinese(text), pi);
		mNotifMan.notify(NOTIF_CONNECTED, n); // 开始显示推送
	}

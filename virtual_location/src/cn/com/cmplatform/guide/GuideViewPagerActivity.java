package cn.com.cmplatform.guide;
	...
	public void initView() {
	 ...
	 private void prepareData() {
		...
		public void onPageScrollStateChanged(int arg0) {
			...
			Log.i("2222", "position");
			Log.i("2222", "position" +previousSelectPosition);
			if (previousSelectPosition == 4)
			{
				Bundle b = new Bundle();
			    ...
			    i.setClass( GuideViewPagerActivity.this, PlatformMainActivity.class);
		...
		public void onPageScrolled(int arg0, float arg1, int arg2) {
			// TODO Auto-generated method stub
			Log.i("3333", "position");
			Log.i("3333", "position" +previousSelectPosition);
			
		}

		@Override
		public void onPageSelected(int position) {
			Log.i("1111", "position" +previousSelectPosition);
